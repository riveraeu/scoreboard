...
function ModelPage({ onBack, calibData, calibLoading, fetchCalib, authToken }) {
  ...
  const TAB_ROWS = [
    ...
    { sport:"NBA", tabs:[
      ...
      { id:"nba-1htotal",  label:"NBA 1H Total" },
      { id:"nba-1hspread", label:"NBA 1H Spread" },
      { id:"nba-1hml",     label:"NBA 1H ML (3-way)" },
      { id:"nba-2htotal",  label:"NBA 2H Total" },
      { id:"nba-2hspread", label:"NBA 2H Spread" },
      { id:"nba-2hml",     label:"NBA 2H ML (3-way)" },
    ]},
    { sport:"WNBA", tabs:[
      { id:"wnba-ml", label:"WNBA Moneyline" },
      { id:"wnba-spread", label:"WNBA Spread" },
      { id:"wnba-1htotal",  label:"WNBA 1H Total" },
      { id:"wnba-1hspread", label:"WNBA 1H Spread" },
      { id:"wnba-1hml",     label:"WNBA 1H ML (3-way)" },
      { id:"wnba-2htotal",  label:"WNBA 2H Total" },
      { id:"wnba-2hspread", label:"WNBA 2H Spread" },
      { id:"wnba-2hml",     label:"WNBA 2H ML (3-way)" },
    ]},
    { sport:"NHL", tabs:[
