                    ...
                    <div key={`${sport}|${stat}`} style={{marginBottom:18}}>
                      ...
                      {(() => {
                        ...
                        const xcell = (m, k) => {
                          ...
                          if (k==="homeWhip"||k==="awayWhip") { const v = m[k==="homeWhip"?"homeWHIP":"awayWHIP"]; return v!=null ? <span style={{color:v>1.35?"#3fb950":v>1.20?"#e3b341":"#8b949e",fontWeight:600}}>{v.toFixed(2)}</span> : DASH; }
