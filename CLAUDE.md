...
- **H2H HR%**: scoring team's hit rate (scored ≥ threshold) in last 10 H2H games vs opponent. Fetches both 2025 and 2026 ESPN season schedules in parallel and merges them (2025 prepended so `.slice(-10)` prefers 2026). Cached `teamschedule:v2:{sport}:{abbr}` at 3600s TTL. Requires ≥3 H2H games; null = 1pt abstain. `isBust` clears this cache. MLB replaces oppRPG; NBA replaces spread.
