...
- **SimScore** (max 14, no edge bonus — edge gates separately):
  ...
  - O/U tier (`totalPts`): ≤ 7.5 → 2pts (low total = pitcher dominant), ≤ 8.5 → 1pt, >8.5 → 0pts; null → 1pt
...
- `totalPts`: 0/1/2 — O/U tier score. Color in UI: 2=green, 1=yellow, 0=red. Drives O/U column color in market report (≤7.5 green, ≤8.5 yellow, >8.5 red). Low total = pitcher dominant = favorable for Ks.
