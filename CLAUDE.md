...
- **SimScore** (max 14, no edge bonus — edge gates separately):
  ...
  - ML tier (`mlPts`): ≤ -121 → 2pts, -120 to -1 → 1pt, ≥ 0 → 0pts; null → 1pt
...
- `mlPts`: 0/1/2 — ML tier score. Color in UI: 2=green, 1=yellow, 0=red. Also drives ML column color in market report (≤-121 green, -120 to -1 yellow, ≥0 red).
