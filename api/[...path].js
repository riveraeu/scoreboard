      ...
      if (path === "auth/register" && method === "POST") {
        ...
        const totalPlays = [];
        {
          ...
          for (const tm of totalMarkets) {
            ...
            // Require noKalshiPct > 30 (YES < 70) so we don't bet a 30% longshot under
