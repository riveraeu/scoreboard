                    ...
                    <div key={`${sport}|${stat}`} style={{marginBottom:18}}>
                      ...
                      {(() => {
                        ...
                        const xcell = (m, k) => {
                          ...
                          if (k==="totalOu") { const v = m.sport==="nba" ? (m.gameOuLine ?? m.threshold) : m.threshold; if (v == null) return DASH; const line = m.sport==="nba" ? v.toFixed(1) : (v-0.5).toFixed(1); const color = m.sport==="nba" ? (v>=225?"#3fb950":v>=215?"#e3b341":"#8b949e") : m.sport==="nhl" ? (v>=6?"#3fb950":v>=5?"#e3b341":"#8b949e") : "#8b949e"; return <span style={{color,fontWeight:600}}>O{line}</span>; }
