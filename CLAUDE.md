...
| `/api/sportsbook-deltas` | `shadow.js` | GET (ADMIN/JWT) — multi-day Kalshi-vs-sharp-book ML divergence. `meanSigned>0` = Kalshi systematically cheap = lag edge. Populated only once `THE_ODDS_API_KEY` is provisioned |
