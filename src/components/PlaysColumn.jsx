                      ...
                      {play.sport === "mlb" && (() => {
                        ...
                        return (
                          <div style={{background:"#0d1117",borderRadius:8,padding:"8px 10px",fontSize:11,color:"#8b949e",lineHeight:1.65}}>
                            {ssnRate != null && <><span style={{color:"#c9d1d9"}}>{play.scoringTeam}</span>{" "}<span style={{color:"#484f58"}}>{isUnder ? `has stayed under ${lineVal} in` : `has scored ${lineVal}+ in`}</span>{" "}<span style={{color:ssnColor,fontWeight:600}}>{isUnder ? (100 - ssnRate).toFixed(0) : ssnRate.toFixed(0)}%</span>{" "}<span style={{color:"#484f58"}}>of games this season{ssnDesc ? ` — ${ssnDesc}` : ""}.</span>{" "}</>}
                            <span style={{color:"#484f58"}}>Facing a</span>{" "}<span style={{color:"#c9d1d9"}}>{play.oppTeam}</span>{" "}<span style={{color:"#484f58"}}>starter</span>{play.oppWHIP != null ? <>{" "}<span style={{color:"#484f58"}}>with</span>{" "}<span style={{color:whipColor,fontWeight:600}}>{play.oppWHIP.toFixed(2)} WHIP</span>{whipDesc ? <span style={{color:"#484f58"}}>{" — "}{whipDesc}</span> : ""}</> : ""}.{" "}
                            {play.teamL10RPG != null && <><span style={{color:"#c9d1d9"}}>{play.scoringTeam}</span>{" "}<span style={{color:"#484f58"}}>averages</span>{" "}<span style={{color:l10Color,fontWeight:600}}>{play.teamL10RPG.toFixed(1)}</span>{" "}<span style={{color:"#484f58"}}>runs/game over their last 10 games{l10Desc ? ` — ${l10Desc}` : ""}.</span>{" "}</>}
                            {play.h2hHitRate != null && <><span style={{color:"#c9d1d9"}}>{play.scoringTeam}</span>{" "}<span style={{color:"#484f58"}}>{isUnder ? `has stayed under ${lineVal} in` : `has scored ${lineVal}+ in`}</span>{" "}<span style={{color:h2hColor,fontWeight:600}}>{isUnder ? (100 - play.h2hHitRate).toFixed(0) : play.h2hHitRate.toFixed(0)}%</span>{" "}<span style={{color:"#484f58"}}>of last {play.h2hGames}g H2H meetings.</span>{" "}</>}
                            {play.gameOuLine != null && <><span style={{color:"#484f58"}}>Game total</span>{" "}<span style={{color:ouColor,fontWeight:600}}>{play.gameOuLine}</span>{ouDesc ? <span style={{color:"#484f58"}}>{" — "}{ouDesc}</span> : ""}.</>}
                  ...
                  <div key={playKey}
                    ...
                    <div style={{display:"flex",flexDirection:"column",gap:8,marginTop:4}}>
                      ...
                      {play.sport === "mlb" && (() => {
                        ...
                        return (
                          <div style={{background:"#0d1117",borderRadius:8,padding:"8px 10px",fontSize:11,color:"#8b949e",lineHeight:1.65}}>
                            <span style={{color:"#c9d1d9"}}>{play.homeTeam}</span>{" "}<span style={{color:"#484f58"}}>starter has</span>{hWHIP != null ? <>{" "}<span style={{color:whipColor(hWHIP),fontWeight:600}}>{hWHIP.toFixed(2)} WHIP</span>{whipDesc(hWHIP,isUnder) ? <span style={{color:"#484f58"}}>{" — "}{whipDesc(hWHIP,isUnder)}</span> : ""}</> : <>{" — WHIP"}</>}.
                            {" "}<span style={{color:"#c9d1d9"}}>{play.awayTeam}</span>{" "}<span style={{color:"#484f58"}}>starter has</span>{aWHIP != null ? <>{" "}<span style={{color:whipColor(aWHIP),fontWeight:600}}>{aWHIP.toFixed(2)} WHIP</span>{whipDesc(aWHIP,isUnder) ? <span style={{color:"#484f58"}}>{" — "}{whipDesc(aWHIP,isUnder)}</span> : ""}</> : <>{" — WHIP"}</>}.
                            {combinedRPG != null && <>{" "}<span style={{color:"#484f58"}}>Combined road scoring:</span>{" "}<span style={{color:isUnder?(combinedRPG<=8.5?"#3fb950":combinedRPG<=10.0?"#e3b341":"#f78166"):(combinedRPG>=10.5?"#3fb950":combinedRPG>=9.0?"#e3b341":"#f78166"),fontWeight:600}}>{combinedRPG.toFixed(1)} runs/game</span><span style={{color:"#484f58"}}>{isUnder?(combinedRPG<=8.5?" — low combined offense":combinedRPG<=10.0?" — moderate scoring":" — high combined offense"):(combinedRPG>=10.5?" — high combined offense":combinedRPG>=9.0?" — above-average scoring":" — below-average offense")}.</span></>}
                            {h2hTR != null && <>{" "}<span style={{color:"#484f58"}}>Combined totals {isUnder?"stayed under":"hit"}</span>{" "}<span style={{color:isUnder?((100-h2hTR)>=80?"#3fb950":(100-h2hTR)>=60?"#e3b341":"#f78166"):(h2hTR>=80?"#3fb950":h2hTR>=60?"#e3b341":"#f78166"),fontWeight:600}}>{isUnder?(100-h2hTR).toFixed(0):h2hTR.toFixed(0)}%</span>{" "}<span style={{color:"#484f58"}}>of last {h2hTRGames}g H2H meetings.</span></>}
                            {gameOuLine != null && <>{" "}<span style={{color:"#484f58"}}>Game total</span>{" "}<span style={{color:ouColor,fontWeight:600}}>{gameOuLine}</span>{ouDesc ? <span style={{color:"#484f58"}}>{" — "}{ouDesc}.</span> : "."}</>}
                            {Math.abs(pf - 1) > 0.01 && <>{" "}<span style={{color:"#484f58"}}>Tonight's park {pf > 1 ? "inflates run scoring" : "suppresses run scoring"} (</span><span style={{color:"#8b949e"}}>{pf > 1 ? "+" : ""}{((pf-1)*100).toFixed(0)}%</span><span style={{color:"#484f58"}}>).</span></>}
                            {et != null && <>{" "}<span style={{color:"#484f58"}}>Model projects</span>{" "}<span style={{color:etColor,fontWeight:600}}>{et}</span>{" "}<span style={{color:"#484f58"}}>{isUnder?`combined runs — under the ${lineVal} threshold.`:`combined runs vs the ${lineVal} threshold.`}</span></>}
                      ...
                      {play.sport === "nba" && (() => {
                        ...
                        return (
                          <div style={{background:"#0d1117",borderRadius:8,padding:"8px 10px",fontSize:11,color:"#8b949e",lineHeight:1.65}}>
                            {paceAdj != null ? <><span style={{color:"#484f58"}}>Projected game pace</span>{" "}<span style={{color:paceColor,fontWeight:600}}>{paceAdj > 0 ? "+" : ""}{paceAdj}</span>{" "}<span style={{color:"#484f58"}}>vs league avg{isUnder?(paceAdj<-2?" — slow game, fewer possessions":" — near average"):(paceAdj>0?" — fast game, more possessions":paceAdj>-2?" — near league average":" — slow game, fewer possessions")}.</span></> : <span style={{color:"#484f58"}}>Pace unavailable.</span>}
                            {" "}<span style={{color:"#c9d1d9"}}>{play.homeTeam}</span>{" "}<span style={{color:"#484f58"}}>offensive rating</span>{" "}<span style={{color:offRtgColor(hOffRtg),fontWeight:600}}>{hOffRtg != null ? hOffRtg.toFixed(1) : "—"}</span>{hOffRtg != null ? <span style={{color:"#484f58"}}>{isUnder?(hOffRtg<113?" — low-scoring":hOffRtg<118?" — average offense":" — high-powered offense"):(hOffRtg>=118?" — elite offense":hOffRtg>=113?" — above-average":"")}</span> : null}.
                            {" "}<span style={{color:"#c9d1d9"}}>{play.awayTeam}</span>{" "}<span style={{color:"#484f58"}}>offensive rating</span>{" "}<span style={{color:offRtgColor(aOffRtg),fontWeight:600}}>{aOffRtg != null ? aOffRtg.toFixed(1) : "—"}</span>{aOffRtg != null ? <span style={{color:"#484f58"}}>{isUnder?(aOffRtg<113?" — low-scoring":aOffRtg<118?" — average offense":" — high-powered offense"):(aOffRtg>=118?" — elite offense":aOffRtg>=113?" — above-average":"")}</span> : null}.
                            {" "}<span style={{color:isUnder?(totalOut>=3?"#3fb950":totalOut>0?"#e3b341":"#8b949e"):(totalOut>=3?"#f78166":totalOut>0?"#e3b341":"#8b949e"),fontWeight:600}}>{totalOut === 0 ? "No key injuries" : `${totalOut} player${totalOut!==1?"s":""} out`}</span>{totalOut > 0 ? <span style={{color:"#484f58"}}>{" "}({homeOut>0?`${homeOut} ${play.homeTeam}`:""}{homeOut>0&&awayOut>0?", ":""}{awayOut>0?`${awayOut} ${play.awayTeam}`:""}).</span> : <span style={{color:"#484f58"}}>.</span>}
                            {nbaOuLinePC != null && <>{" "}<span style={{color:"#484f58"}}>Game total</span>{" "}<span style={{color:isUnder?(nbaOuLinePC<225?"#3fb950":nbaOuLinePC<235?"#e3b341":"#f78166"):(nbaOuLinePC>=235?"#3fb950":nbaOuLinePC>=225?"#e3b341":"#8b949e"),fontWeight:600}}>{nbaOuLinePC}</span>{" "}<span style={{color:"#484f58"}}>{isUnder?(nbaOuLinePC<225?"— a low-total game.":nbaOuLinePC<235?"— an average total.":"— a high-total game."):(nbaOuLinePC>=235?"— a fast-paced game.":nbaOuLinePC>=225?"— above-average scoring.":"— a low-total game.")}</span></>}
                            {et != null && <>{" "}<span style={{color:"#484f58"}}>Model projects</span>{" "}<span style={{color:etColor,fontWeight:600}}>{et}</span>{" "}<span style={{color:"#484f58"}}>{isUnder?`combined pts — under the ${lineVal} threshold.`:`combined pts vs the ${lineVal} threshold.`}</span></>}
                            {" "}<span title={scTitle} style={{background:"#161b22",borderRadius:4,padding:"1px 5px",color:scColor,fontWeight:700,fontSize:10,verticalAlign:"middle",cursor:"default"}}>{sc}/10 {sc>=8?"Alpha":sc>=5?"Mid":"Low"}</span>
                          </div>
                        );
                      })()}
                      ...
                      {play.sport === "nhl" && (() => {
                        ...
                        return (
                          <div style={{background:"#0d1117",borderRadius:8,padding:"8px 10px",fontSize:11,color:"#8b949e",lineHeight:1.65}}>
                            <span style={{color:"#c9d1d9"}}>{play.homeTeam}</span>{" "}<span style={{color:"#484f58"}}>averages</span>{hGPG != null ? <>{" "}<span style={{color:gpgColor(hGPG),fontWeight:600}}>{hGPG.toFixed(1)} GPG</span>{!isUnder&&hGPG>=3.5?<span style={{color:"#484f58"}}> — high-scoring offense</span>:!isUnder&&hGPG>=3.0?<span style={{color:"#484f58"}}> — above-average scoring</span>:isUnder&&hGPG<3.0?<span style={{color:"#484f58"}}> — low-scoring offense</span>:""}</> : <>{" —"}</>}.
                            {" "}<span style={{color:"#c9d1d9"}}>{play.awayTeam}</span>{" "}<span style={{color:"#484f58"}}>averages</span>{aGPG != null ? <>{" "}<span style={{color:gpgColor(aGPG),fontWeight:600}}>{aGPG.toFixed(1)} GPG</span>{!isUnder&&aGPG>=3.5?<span style={{color:"#484f58"}}> — high-scoring offense</span>:!isUnder&&aGPG>=3.0?<span style={{color:"#484f58"}}> — above-average scoring</span>:isUnder&&aGPG<3.0?<span style={{color:"#484f58"}}> — low-scoring offense</span>:""}</> : <>{" —"}</>}.
                            {" "}<span style={{color:"#c9d1d9"}}>{play.homeTeam}</span>{" "}<span style={{color:"#484f58"}}>defense allows</span>{hGAA != null ? <>{" "}<span style={{color:gaaColor(hGAA),fontWeight:600}}>{hGAA.toFixed(2)} GAA</span>{!isUnder&&hGAA>=3.5?<span style={{color:"#484f58"}}> — weak defense</span>:!isUnder&&hGAA>=3.0?<span style={{color:"#484f58"}}> — below-average defense</span>:isUnder&&hGAA<3.0?<span style={{color:"#484f58"}}> — stingy defense</span>:""}</> : <>{" —"}</>}.
                            {" "}<span style={{color:"#c9d1d9"}}>{play.awayTeam}</span>{" "}<span style={{color:"#484f58"}}>defense allows</span>{aGAA != null ? <>{" "}<span style={{color:gaaColor(aGAA),fontWeight:600}}>{aGAA.toFixed(2)} GAA</span>{!isUnder&&aGAA>=3.5?<span style={{color:"#484f58"}}> — weak defense</span>:!isUnder&&aGAA>=3.0?<span style={{color:"#484f58"}}> — below-average defense</span>:isUnder&&aGAA<3.0?<span style={{color:"#484f58"}}> — stingy defense</span>:""}</> : <>{" —"}</>}.
                            {nhlOuLinePC != null && <>{" "}<span style={{color:"#484f58"}}>Game total</span>{" "}<span style={{color:isUnder?(nhlOuLinePC<5.5?"#3fb950":nhlOuLinePC<7?"#e3b341":"#f78166"):(nhlOuLinePC>=7?"#3fb950":nhlOuLinePC>=5.5?"#e3b341":"#8b949e"),fontWeight:600}}>{nhlOuLinePC}</span>{" "}<span style={{color:"#484f58"}}>{isUnder?(nhlOuLinePC<5.5?"— a low-total game.":nhlOuLinePC<7?"— an average total.":"— a high-scoring game."):(nhlOuLinePC>=7?"— a high-scoring game.":nhlOuLinePC>=5.5?"— an average total.":"— a low-total game.")}</span></>}
                            {et != null && <>{" "}<span style={{color:"#484f58"}}>Model projects</span>{" "}<span style={{color:etColor,fontWeight:600}}>{et}</span>{" "}<span style={{color:"#484f58"}}>{isUnder?`combined goals — under the ${lineVal} threshold.`:`combined goals vs the ${lineVal} threshold.`}</span></>}
                            {" "}<span title={scTitle} style={{background:"#161b22",borderRadius:4,padding:"1px 5px",color:scColor,fontWeight:700,fontSize:10,verticalAlign:"middle",cursor:"default"}}>{sc}/10 {sc>=8?"Alpha":sc>=5?"Mid":"Low"}</span>
                          </div>
                        );
                      })()}
                  ...
                  <div style={{display:"flex",flexDirection:"column",gap:8,marginTop:play.sport==="mlb"?0:8}}>
                        ...
                        {play.stat === "strikeouts" && play.sport === "mlb" && (() => {
                          ...
                          return (
                            <div style={{background:"#0d1117",borderRadius:8,padding:"8px 10px",fontSize:11,color:"#8b949e",lineHeight:1.65}}>
                              <div>
                                {first} has {pkpQual ? <>{pkpQual} </> : ""}swing-and-miss stuff{pkp != null && <> — <span style={{color:pkpColor,fontWeight:600}}>{pkp}% {pkpLabel}</span></>}{recK != null && <>{", "}<span style={{color:play.kTrendPts===2?"#3fb950":play.kTrendPts===0?"#f78166":"#e3b341",fontWeight:600}}>{recK.toFixed(1)}%</span>{" "}<span style={{color:"#484f58"}}>recent{play.kTrendPts===2?" ↑":play.kTrendPts===0?" ↓":""}{seaK!=null?` (${seaK.toFixed(1)}% season)`:""}</span></>}{ap != null && <>{", "}<span style={{color:"#484f58"}}>avg {Math.round(ap)} pitches/start</span></>}.
                                {lkp != null && <>{" "}The <span style={{color:"#c9d1d9"}}>{oppName}</span> lineup strikes out at <span style={{color:lkpColor,fontWeight:600}}>{lkp}%</span>{handLabel}{isProjected ? <span style={{color:"#484f58",fontSize:10}}> (est.)</span> : ""}<span style={{color:"#484f58"}}>{lkpDesc ? ` — ${lkpDesc}` : ""}.</span></>}
                                {blendedHitRate != null && <>{" "}<span style={{color:"#484f58"}}>Hit rate at this line:</span>{" "}<span style={{color:hitRateColor,fontWeight:600}}>{blendedHitRate.toFixed(0)}%</span>{" "}<span style={{color:"#484f58"}}>{kHitRatePts===2?"— consistently reaches this mark.":kHitRatePts===1?"— reaches this mark often.":"— struggles to reach this mark."}</span></>}
                                {h2hHandRate != null && <>{" "}<span style={{color:"#484f58"}}>{h2hHandMaj?`vs ${h2hHandMaj}-heavy lineups:`:"Hand H2H:"}</span>{" "}<span style={{color:h2hHandColor,fontWeight:600}}>{h2hHandRate.toFixed(0)}% hit rate</span>{h2hHandStarts!=null&&<span style={{color:"#484f58",fontSize:10}}> ({h2hHandStarts} starts)</span>}{" "}<span style={{color:"#484f58"}}>{h2hHandPts===2?"— strong vs this lineup type.":h2hHandPts===1?"— solid vs this lineup type.":"— struggles vs this lineup type."}</span></>}
                                {gameTotal != null && <>{" "}<span style={{color:"#484f58"}}>Game total</span>{" "}<span style={{color:totalColor(gameTotal),fontWeight:600}}>{gameTotal}</span>{" "}<span style={{color:"#484f58"}}>{gameTotal<=7.5?"— a low-scoring slate, favorable for strikeouts.":gameTotal<10.5?"— an average total.":"— a high-scoring total, tougher for Ks."}</span></>}
                                {pf != null && Math.abs(pf - 1.0) >= 0.01 && <>{" "}<span style={{color:"#484f58"}}>Park factor: {pf > 1 ? "strikeout-friendly" : "suppresses Ks"} (</span><span style={{color:"#8b949e"}}>{pf > 1 ? "+" : ""}{((pf-1)*100).toFixed(0)}%</span><span style={{color:"#484f58"}}>).</span></>}
                          ...
                          return (
                            <div style={{background:"#0d1117",borderRadius:8,padding:"8px 10px",fontSize:11,color:"#8b949e",lineHeight:1.65}}>
                              <div>
                                ...
                                {play.softPct != null && <>{" "}<span style={{color:softRateColor,fontWeight:600}}>{play.softPct}%</span>{" "}<span style={{color:"#484f58"}}>{play.hitterSoftLabel ?? "against weak pitching matchups"}{isPlatoonFallback && play.hitterSplitBA != null ? ` (hits .${Math.round(play.hitterSplitBA*1000).toString().padStart(3,"0")} vs ${pitcherHand === "R" ? "RHP" : "LHP"})` : !isPlatoonFallback && play.softGames ? ` (${play.softGames}g)` : ""}.</span></>}
                        ...
                        {play.sport === "nba" && (() => {
                          ...
                          return (
                            <div style={{background:"#0d1117",borderRadius:8,padding:"8px 10px",fontSize:11,color:"#8b949e",lineHeight:1.65}}>
                              <div>
                                {play.nbaOpportunity != null ? <>{first} averages <span style={{color:minColor,fontWeight:600}}>{play.nbaOpportunity.toFixed(0)} minutes</span> a night{minDesc ? <span style={{color:"#484f58"}}> — {minDesc}</span> : ""}{play.stat === "assists" && play.nbaAvgAst != null ? <> (<span style={{color:play.nbaAvgAst>=7?"#3fb950":play.nbaAvgAst>=5?"#e3b341":"#f78166",fontWeight:600}}>{play.nbaAvgAst.toFixed(1)} APG</span>)</> : play.stat === "rebounds" && play.nbaAvgReb != null ? <> (<span style={{color:play.nbaAvgReb>=9?"#3fb950":play.nbaAvgReb>=7?"#e3b341":"#f78166",fontWeight:600}}>{play.nbaAvgReb.toFixed(1)} RPG</span>)</> : play.nbaUsage != null ? <> (<span style={{color:play.nbaUsage>=28?"#3fb950":play.nbaUsage>=22?"#e3b341":"#f78166",fontWeight:600}}>{play.nbaUsage.toFixed(0)}% USG</span>)</> : ""}.</> : null}
                        ...
                        {play.sport === "nhl" && (() => {
                          ...
                          return (
                            <div style={{background:"#0d1117",borderRadius:8,padding:"8px 10px",fontSize:11,color:"#8b949e",lineHeight:1.65}}>
                              <div>
                                {play.nhlOpportunity != null ? <>{first} averages <span style={{color:toiColor,fontWeight:600}}>{play.nhlOpportunity.toFixed(0)} min</span> of ice time{toiDesc ? <span style={{color:"#484f58"}}> — {toiDesc}</span> : ""}.</> : null}
                                {" "}{first} hits this line in <span style={{color:seasonColor,fontWeight:600}}>{play.seasonPct}%</span> of games{play.seasonGames ? <span style={{color:"#484f58",fontSize:10}}> ({play.seasonGames}g)</span> : ""}.
                                {play.oppRank != null && <>{" "}<span style={{color:"#c9d1d9"}}>{play.opponent}</span>{" "}<span style={{color:"#484f58"}}>{rankDesc ? `has ${rankDesc} in goals against` : `ranks ${ordinal(play.oppRank)} in goals against`} — ranked</span>{" "}<span style={{color:rankColor,fontWeight:700}}>{ordinal(play.oppRank)}</span><span style={{color:"#484f58"}}>.</span></>}
                                {play.softPct != null && <>{" "}{first} hits this in <span style={{color:play.softPct>=90?"#3fb950":play.softPct>=80?"#e3b341":"#f78166",fontWeight:600}}>{play.softPct}%</span>{" "}<span style={{color:"#484f58"}}>vs weak defenses{play.softGames ? ` (${play.softGames}g)` : ""}.</span></>}
                                {play.nhlGameTotal != null && <>{" "}<span style={{color:"#484f58"}}>Game total</span>{" "}<span style={{color:_nhlTotalPtsPC===2?"#3fb950":_nhlTotalPtsPC===1?"#e3b341":"#8b949e",fontWeight:600}}>{play.nhlGameTotal}</span>{" "}<span style={{color:"#484f58"}}>{play.nhlGameTotal>=7?"— a high-scoring game.":play.nhlGameTotal>=5.5?"— an average total.":"— a low-total game."}</span></>}
                                {play.isB2B != null && <>{" "}{play.isB2B ? <><span style={{color:"#f78166",fontWeight:600}}>Back-to-back</span><span style={{color:"#484f58"}}> — model applies a fatigue reduction.</span></> : <><span style={{color:"#484f58"}}>Fully rested tonight.</span></>}</>}
                                {sc != null && <>{" "}<span title={scTitle} style={{background:"#161b22",borderRadius:4,padding:"1px 5px",color:scColor,fontWeight:700,fontSize:10,cursor:"default",verticalAlign:"middle"}}>{sc}/10 {sc>=8?"Alpha":"Mid"}</span></>}
                              </div>
                            </div>
                          );
