...
| Sub-50 one-sided live trial (`mlb\|f5total\|10-14` + 3 diagnostic cells added 8/26; `wnba\|points` HALTED 8/26) — mechanism, sizing, per-group caps/stop-losses, checkpoints | `docs/MAKER_V2_SUBFIFTY_TRIAL.md` — **LIVE** at 4 groups, re-armed 2026-08-25, expanded then partially halted 2026-08-26 (`armed:true` confirmed via `/api/maker-v2-board`) |
