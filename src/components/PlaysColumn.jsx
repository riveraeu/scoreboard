                  ...
                  <div key={playKey}
                    ...
                    <div style={{marginTop:4}}>
                      ...
                      {play.sport === "nba" && (() => {
                        ...
                        return (
                          <div style={{background:"#0d1117",borderRadius:8,padding:"8px 10px",fontSize:11,color:"#8b949e",lineHeight:1.65}}>
                            <span style={{color:"#c9d1d9"}}>{play.scoringTeam}</span> averages{play.teamOff != null ? <> <span style={{color:offColor(play.teamOff),fontWeight:600}}>{play.teamOff.toFixed(0)} PPG</span></> : " —"}{offDesc ? <> — <span style={{color:"#8b949e"}}>{offDesc}</span></> : null}.{" "}
                            The <span style={{color:"#c9d1d9"}}>{play.oppTeam}</span> defense allows{play.oppDef != null ? <> <span style={{color:defColor(play.oppDef),fontWeight:600}}>{play.oppDef.toFixed(0)} PPG</span></> : " —"}{defDesc ? <> — <span style={{color:"#8b949e"}}>{defDesc}</span></> : null}.
                      ...
                      {play.sport === "nba" && (() => {
                        ...
                        return (
                          <div style={{background:"#0d1117",borderRadius:8,padding:"8px 10px",fontSize:11,color:"#8b949e",lineHeight:1.65}}>
                            ...
                            {" "}<span style={{color:"#c9d1d9"}}>{play.homeTeam}</span>{" "}<span style={{color:"#8b949e"}}>offensive rating</span>{" "}<span style={{color:offRtgColor(hOffRtg),fontWeight:600}}>{hOffRtg != null ? hOffRtg.toFixed(1) : "—"}</span>{hOffRtg != null ? <span style={{color:"#8b949e"}}>{isUnder?(hOffRtg<113?" — low-scoring":hOffRtg<118?" — average offense":" — high-powered offense"):(hOffRtg>=118?" — elite offense":hOffRtg>=113?" — above-average":"")}</span> : null}.
                            {" "}<span style={{color:"#c9d1d9"}}>{play.awayTeam}</span>{" "}<span style={{color:"#8b949e"}}>offensive rating</span>{" "}<span style={{color:offRtgColor(aOffRtg),fontWeight:600}}>{aOffRtg != null ? aOffRtg.toFixed(1) : "—"}</span>{aOffRtg != null ? <span style={{color:"#8b949e"}}>{isUnder?(aOffRtg<113?" — low-scoring":aOffRtg<118?" — average offense":" — high-powered offense"):(aOffRtg>=118?" — elite offense":aOffRtg>=113?" — above-average":"")}</span> : null}.
