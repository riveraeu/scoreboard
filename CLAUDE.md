...
| Sub-50 one-sided live trial (`mlb\|f5total\|10-14` + 3 diagnostic cells added 8/26 + `wnbapts-1014` added 8/27; `wnba\|points` original cells HALTED 8/26) — mechanism, sizing, per-group caps/stop-losses, checkpoints | `docs/MAKER_V2_SUBFIFTY_TRIAL.md` — **LIVE** at 5 groups, re-armed 2026-08-25, expanded 8/26 + 8/27 (`armed:true` confirmed via `/api/maker-v2-board`) |
