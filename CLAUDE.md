...
- `mlPts`: 0/1/2 — ML tier score. Color in UI: 2=green, 1=yellow, 0=red. Also drives ML column color in market report (≤-121 green, -120 to +120 yellow, >+120 red). Explanation text uses gameML < 0 to label: heavy favorite (≤-121) / slight favorite (-120 to -1) / underdog (≥0).
