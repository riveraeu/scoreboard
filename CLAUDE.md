...
| `simulateKsDist(orderedKPcts, pitcherKPct, parkFactor, nSim, totalPA, earlyExitProb)` | Shared Monte Carlo, returns `Int16Array` of K counts; TTO decay applied at BF≥19; `earlyExitProb` controls blowout-hook early-exit fraction |
