...
| Sub-50 one-sided live trial (`wnba\|points`, `mlb\|f5total\|10-14`, + 2 diagnostic cells added 8/26) — mechanism, sizing, per-group caps/stop-losses, checkpoint | `docs/MAKER_V2_SUBFIFTY_TRIAL.md` — **LIVE**, re-armed 2026-08-25, expanded 2026-08-26 (`armed:true` confirmed via `/api/maker-v2-board`) |
