...
| Sub-50 one-sided live trial (`mlb\|f5total\|10-14` + 3 diagnostic cells added 8/26 + `wnbapts-1014` added 8/27; `wnba\|points` HALTED 8/26, RE-ARMED 8/27 at halved sizing) — mechanism, sizing, per-group caps/stop-losses, checkpoints | `docs/MAKER_V2_SUBFIFTY_TRIAL.md` — **LIVE** at 7 groups, re-armed 2026-08-25 + 2026-08-27, expanded 8/26 + 8/27 (`armed:true` confirmed via `/api/maker-v2-board`) |
