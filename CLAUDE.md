...
- `tonight/club-soccer-ml.js` — MLS game winner (KXMLSGAME, adopted 2026-07-23), **model-free** (no probability, see `api/lib/mls.js` above) — the module that first surfaced the gameTime:null bug and was fixed first; now one of 7 (with tennis/soccer/fight/nba-summer/lmb-ml/nascar) that populate a real `gameTime`
