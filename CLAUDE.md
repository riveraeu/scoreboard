...
`homeLambda = homeRoadRPG × awayMult × parkRF × homePlatoonFactor × weatherFactor`, clamped [1, 12]
`awayLambda = awayRoadRPG × homeMult × parkRF × awayPlatoonFactor × weatherFactor`, clamped [1, 12]
